...
async def quote_cmd(_, m: Message):
    ...
    await m.reply_text(build_quote(q), parse_mode="html")
...
async def subscribxxe_cmd(client, m: Message):
    ...
    await m.reply_text(f"✅ Subscribed! Daily quote at <b>{time} UTC</b>.", parse_mode="html")
...
async def sgsettime_cmd(client, m: Message):
    ...
    await m.reply_text(f"🕒 Time updated to <b>{t} UTC</b>.", parse_mode="html")
