...
async def start_djcmd(_, m: Message):
    ...
    await m.reply(
        ...
        "• /shop — buyable items\n"
        "• /inventory — your bag\n"
        "• /recipes — crafting list\n\n"
        "**Work**: /chop, /fish, /pickup, /mine\n"
        "**Economy**: /buy, /sell, /trade\n"
        "**Crafting**: /craft <item>\n"
        "**PvP**: /duel @user <bet>\n"
        "**Dungeon**: /dungeon\n"
        "**Gamble**: /coinflip, /dice, /blackjack, /slots, /wheel, /multidice\n"
        "**Other**: /daily, /enchant, /pet, /guild, /meme, /leaderboard"
    )
